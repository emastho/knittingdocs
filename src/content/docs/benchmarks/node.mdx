---
title: Node.js
description: "Knitting on Node.js: message overhead, a head-to-head with a plain worker, latency as calls grow, heavy-task efficiency, and payload type costs."
sidebar:
  order: 2
---
