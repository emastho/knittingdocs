...
particle moves one unit at a time and stops when it reaches a radius boundary
or its step limit.

Every trial can take a different number of steps. That variable work makes this
a useful example for chunking and load balancing.
