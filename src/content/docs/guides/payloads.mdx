---
title: Payloads
description: The data types you can pass into a task and return from one.
sidebar:
  order: 3
---
...
executed. Only native `Promise` instances are awaited; thenables are treated as regular
values.

See [Promise inputs are awaited on the host](/guides/defining-tasks/#promise-inputs-are-awaited-on-the-host) for details.
...
copying, which adds measurable overhead in hot loops.
